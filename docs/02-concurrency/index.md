...
<InteractiveModal title="Concurrency Overview" icon="🗺️" description="Интерактивная карта примитивов конкурентности Go">
...
::: tip Что уже рассмотрено в разделе Runtime
Раздел [GMP Scheduler](/01-runtime/gmp-scheduler) покрывает:
